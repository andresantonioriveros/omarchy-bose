...
Item {
  ...
  function pathForVariant(kind) {
    ...
    if (kind === "equalizer") {
      return "M12 6.1A5.9 5.9 0 1 0 12 17.9A5.9 5.9 0 0 0 12 6.1ZM12 8A4 4 0 1 1 12 16A4 4 0 0 1 12 8ZM11.15 1H12.85V4H11.15V1ZM11.15 20H12.85V23H11.15V20ZM1 11.15H4V12.85H1V11.15ZM20 11.15H23V12.85H20V11.15ZM4.08 2.88L6.2 5L5 6.2L2.88 4.08L4.08 2.88ZM19.92 2.88L21.12 4.08L19 6.2L17.8 5L19.92 2.88ZM2.88 19.92L5 17.8L6.2 19L4.08 21.12L2.88 19.92ZM19 17.8L21.12 19.92L19.92 21.12L17.8 19L19 17.8Z"
    }
    if (kind === "back") {
      return "M15.45 4.1L7.55 12L15.45 19.9L16.9 18.45L10.45 12L16.9 5.55L15.45 4.1Z"
    }
  ...
  Shape {
    ...
    ShapePath {
      fillColor: root.color
      strokeWidth: -1
       fillRule: root.variant.indexOf("mode") === 0
         || root.variant === "noise" || root.variant === "equalizer"
